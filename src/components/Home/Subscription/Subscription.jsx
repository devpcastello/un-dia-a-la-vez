...
export const Subscription = () => {
  return (
    <div className="bg-color9 h-screen w-full flex flex-col justify-center items-center md:h-[700px] xl:h-[900px]">
      <div className="w-10/12 h-auto">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 md:my-20 xl:gap-0">
          <div className="flex flex-col justify-center gap-2 xl:gap-4">
            ...
            <input
              className="rounded-full px-4 py-2 w-full bg-color7 text-white xl:px-6 xl:py-3 xl:h-12 xl:w-5/6"
              type="text"
              name="name"
              id="name"
            />
            ...
            <input
              className="rounded-full px-4 py-2 w-full bg-color7 text-start text-white xl:px-6 xl:py-3 xl:h-12 xl:w-5/6"
              type="email"
              name="email"
              id="email"
            />
            <button className="bg-color6 text-white rounded-full py-2 px-4 mt-4 w-full xl:text-2xl xl:px-6 xl:py-3 xl:h-12 xl:w-5/6">
              Subscribirme!
            </button>
          </div>
