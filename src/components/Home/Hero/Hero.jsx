...
export const Hero = () => {
  return (
    <div
      className=" h-screen w-full grid grid-rows-2 justify-center items-center md:grid-cols-2  gap-8"
      id="home"
      style={{ justifyItems: "center", alignItems: "center" }}
    >
      <div className="xl:mt-[500px]">
      ...
      <div className=" mt-5 text-white flex flex-col justify-center items-center z-10 gap-4 md:gap-12 xl:mt-[500px]">
